                ...
                {data &&
                    data?.map((item) => (
                        ...
                        >
                            ...
                            >
                                {item.collection?.title.split(new RegExp(`(${search})`, 'gi')).map((part, index) =>
                                    part.toLowerCase() === search?.toLowerCase() ? (
                                    ...
                                    item.tags.map((tag) => (
                                        ...
                                        >
                                            <Typography variant="body1">
                                                {tag.tag.split(new RegExp(`(${search})`, 'gi')).map((part, index) =>
                                                    part.toLowerCase() === search?.toLowerCase() ? (
                                                        <span style={{ color: 'red', fontSize: '18px' }} key={index}>
                                                            {part}
                                                        </span>
                                                    ) : (
                                                        part
