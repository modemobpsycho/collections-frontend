...
export const messages = {
    [LOCALES.ENGLISH]: {
        ...
        Or_sign_in_with: 'or log in with',
        Log_in_with_Google: 'Log in with Google',
        Log_in_with_GitHub: 'Log in with GitHub',
        Notifications: 'Notifications',
        Item: 'Item',
        Go_to_item: 'Go to item',
        So_far_you_have_not_commented_on_anything: 'You have not yet left any comments on the items',
        You_have_not_left_likes_and_dislikes_yet: 'You have not yet left any likes and dislikes on the items',
        Sign_up_success: 'You have successfully signed up',
        Log_in_success: 'You have successfully logged in',
        Log_in_success_with_google: 'You have successfully logged in with Google',
        ...
        Collection_changed_successfully: 'Collection changed successfully',
        ...
        No_user_collections: 'You have no collections yet - create one!',
    ...
    [LOCALES.RUSSIAN]: {
        ...
        Or_sign_in_with: 'или войдите с помощью',
        Log_in_with_Google: 'Войти с помощью Google',
        Log_in_with_GitHub: 'Войти с помощью GitHub',
        Notification: 'Уведомление',
        Item: 'Предмет',
        Go_to_item: 'Перейти к предмету',
        So_far_you_have_not_commented_on_anything: 'Вы пока что не оставляли никаких комментариев к предметам',
        You_have_not_left_likes_and_dislikes_yet: 'Вы пока не оставляли никаких лайков и дизлайков предметам',
        Sign_up_success: 'Вы успешно зарегистрировались. Вы можете войти в систему',
        Log_in_success: 'Вы успешно вошли в систему',
        Log_in_success_with_google: 'Вы успешно вошли в систему с помощью Google',
        Invalid_email_or_password: 'Неверная почта или пароль',
        User_account_is_blocked: 'Ваш аккаунт заблокирован',
        Email_already_exists: 'Почта уже существует',
        Missing_required_fields: 'Заполните все обязательные поля',
        Collection_added_successfully: 'Коллекция успешно добавлена',
        Internal_Server_Error: 'Внутренняя ошибка сервера',
        Collection_deleted_successfully: 'Коллекция успешно удалена',
        Item_added_successfully: 'Предмет успешно добавлен',
        Logout_successfully: 'Вы вышли из системы',
        User_updated_successfully: 'Данные пользователя успешно обновлены',
        User_deleted_successfully: 'Пользователь успешно удален',
        Collection_changed_successfully: 'Коллекция успешно изменена',
        Item_deleted_successfully: 'Предмет успешно удален',
        ...
        No_user_collections: 'У вас нет ни одной коллекции. Создайте же свою первую коллекцию!',
